...
class FingerVein(object):
    def __init__(self, dataset_name, is_train=True):
        ...
        self.train_rate = 0.5
        self.val_rate = 0.2
        self.test_sample_num_list = [0, 2, 4]#[0, 2, 3]#
...
class HandVein(object):
    def __init__(self, dataset_name, is_train=True):
        self.dataset_name = dataset_name
        self.image_size = (320, 400, 1)  #(240, 600, 1)
        self.num_trains = 0
        self.num_class = 20
        self.is_train = is_train
        ...
        self.train_rate = 0.7
        self.val_rate = 0.2
        self.test_sample_num_list = [3]#[0, 2, 3]#
...
def Dataset(dataset_name, is_train=True):
    ...
    elif dataset_name == 'handvein':
        return HandVein(dataset_name, is_train)
    else:
